...
has_id = bool(has_id_str.strip().lower() == "yes")

# 3) Parse ticket parts by fixed positions
tier = ticket_code[ticket_code.index("VIP"):ticket_code.index("VIP") + len("VIP")]             # "VIP"
seat_number_str = ticket_code[ticket_code.index("023"):ticket_code.index("023") + len("023")]  # "023"
zone = ticket_code[ticket_code.index("A"):ticket_code.index("A") + len("A")]                 # "A"
